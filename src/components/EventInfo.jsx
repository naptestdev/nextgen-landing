  ...
  return (
    <>
      <div className="flex justify-center">
        <div className="w-full max-w-[1500px] md:mx-[4vw] mt-10 mb-4 lg:my-0 lg:min-h-screen flex items-center flex-col lg:flex-row md:gap-6">
          <div className="m-4 flex-1">
            ...
            <ul className="my-3 md:my-6 text-xl font-light list-disc ml-5 md:ml-10 leading-10">
              <li>
      ...
      <div className="flex justify-center">
        <div className="w-full max-w-[1500px] md:mx-[4vw] mt-4 mb-10 lg:my-0 lg:min-h-screen flex items-center flex-col-reverse lg:flex-row md:gap-6">
          <div className="m-4 flex-1">
            <img
              className="object-cover w-full h-auto"
              src="/info-2.png"
